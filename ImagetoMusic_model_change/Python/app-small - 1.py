...
def musicgen(img,text):
    ...
    # 加载音乐生成模型
    music_processor = AutoProcessor.from_pretrained(r"D:\Work\musicgen-small")
    music_model = MusicgenForConditionalGeneration.from_pretrained(r"D:\Work\musicgen-small")
