...
def musicgen(img,text):
    ...
    # 加载音乐生成模型
    music_processor = AutoProcessor.from_pretrained(r"D:\Work\musicgen-large")
    music_model = MusicgenForConditionalGeneration.from_pretrained(r"D:\Work\musicgen-large")
    # 加载图像
    ...
    with gr.Column():
        with gr.Row():
            with gr.Column(scale=4):
                ...
                gr.Examples([r'D:\Work\image_test\test1.jpg',r'D:\Work\image_test\test2.jpg',r'D:\Work\image_test\test3.png',r'D:\Work\image_test\test4.jpg'],label="参考范例",inputs=[input_image])
