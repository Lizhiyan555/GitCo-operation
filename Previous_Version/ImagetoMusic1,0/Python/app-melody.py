...
def musicgen(img,text,dura):
    ...
    # music_model = MusicGen.get_pretrained('facebook/musicgen-melody')
...
with gr.Blocks(gr.themes.Soft()) as demo:
    ...
    button.click(musicgen,[input_image,captioning,dura],[output_music,captioning])
